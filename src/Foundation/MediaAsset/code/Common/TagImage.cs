...
namespace SitecoreMediaTagging.Common
{
    public static class TagImage
    {
        ...
        public static bool GetImageTagsFromAzureAPI(MediaItem mediaItem, Item mainItem)
        {
            ...
            string uriBase = Sitecore.Configuration.Settings.GetSetting("uriBase");
            string subKey = Sitecore.Configuration.Settings.GetSetting("subscriptionKey");

            // Request headers.
            client.DefaultRequestHeaders.Add("Ocp-Apim-Subscription-Key", subKey);

            // Request parameters. A third optional parameter is "details".
            string requestParameters = "api-version=2023-02-01-preview&features=Tags&language=en&gender-neutral-caption=False";
            ...
            using (ByteArrayContent content = new ByteArrayContent(byteData))
            {
                ...
                if (jsonObject != null)
                {
                    try
                    {
                        ...
                        // Extract names from tagsResult.values
                        JArray values = jsonObject["tagsResult"]["values"] as JArray;
                        if (values != null)
                        {
                        ...
                        CreateTaggingItem(tagNames, mainItem);
